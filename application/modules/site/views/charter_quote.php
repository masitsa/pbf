        ...
        <div class="grey-background div-head">
        	<div class="container">
        		...
        		<div class="col-xs-12 col-md-12 col-sm-12">
						...
						?>
						 <div class="row">
						 	<div id="flight-details-heading" class="">
                        		<h4>Flight Details</h4>
                        	</div>
	                    	<div id="flight-details" class="col-xs-12 col-md-12 col-sm-12">
		                        	<div class="col-md-6">
		                        		<div class="form-group">
		                                    <label for="airline_name" class="col-sm-4 control-label">From : </label>
		                                    <div class="col-sm-8">
		                                         <input type="text" class="form-control" name="source" placeholder="From" value="<?php echo $source;?>">
		                                    </div>
		                                </div>
		                            	<div class="form-group">
		                                    <label for="destination" class="col-sm-4 control-label">To : <span class="info">*</span></label>
		                                    <div class="col-sm-8">
		                                    	<?php
													...
													{
														?>
		                                    	 		<input type="text" class="form-control" name="destination" placeholder="To" value="<?php echo $destination;?>">
		                                                <?php
													}
												?>
		                                    </div>
	                        ...
	                        <div class="row">
	                        	<div id="your-details-heading" class="">
	                        		<h4>Your Details</h4>
	                        	</div>
		                        <div id="your-details" class="col-xs-12 col-md-12 col-sm-12" >
			                            <div class="col-md-6">
			                            	<div class="form-group">
