...
<body>
   ...
   <?php echo $this->load->view('includes/account/top_navigation'); ?>
    ...
    <div class="content">
    	<?php echo $this->load->view('includes/account/left_navigation'); ?>
        
        <!-- Main bar -->
        <div class="mainbar background-brown">
                        ...
                        <div class="col-md-12">
                        	<?php //echo $this->load->view('includes/account/welcome'); ?>
                                ...
                                <div class="widget-content">
                                    ...
                                    ?>
                                	<iframe class="classroom-slide" src="<?php echo base_url().'assets/media/cover.swf';?>" frameborder="0" allowfullscreen></iframe>
                                </div>
