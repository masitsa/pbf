...
// get flight details
     if(count($flight) > 0)
     {
       // $flight_result = $flight->result();
        ...
        foreach($flight as $flight_res):
            $flight_id = $flight_res->flight_id;
            $flight_date  = $flight_res->flight_date;   
            $flight_departure_time  = $flight_res->flight_departure_time;   
            $source  = $flight_res->source;    
            $destination  = $flight_res->destination;   
            $airplane_type_idd  = $flight_res->airplane_type_id;   
            $trip_type_idd  = $flight_res->trip_type_id;   
            $flight_type_idd  = $flight_res->flight_type_id;   
                            ...
                            <div class="col-lg-6">
                                <select name="flight_type_id" id="flight_type_id" class="form-control" required>
                                    ...
                                    if($flight_type_query->num_rows() > 0)
                                    {
                                        ...
                                        {
                                            if($res->flight_type_id == $flight_type_idd)
                                            {
                            ...
                            <div class="col-lg-6">
                                <select name="airplane_type_id" id="airplane_type_id" class="form-control" required>
                                    ...
                                    if($airplane_type_query->num_rows() > 0)
                                    {
                                        ...
                                        foreach($result as $res)
                                        {
                                            if($res->airplane_type_id == $airplane_type_idd)
                                            {
                            ...
                            <div class="col-lg-6">
                                ...
                                <select name="source" id="source" class="form-control" required>
                                    ...
                                    if($airports_query->num_rows() > 0)
                                    {
                                        ...
                                        {
                                            if($source_res->airport_id == $source)
                                            {
                            ...
                            <div class="col-lg-6">
                                <select name="trip_type" id="destination" class="form-control" required>
                                    ...
                                    if($trip_type_query->num_rows() > 0)
                                    {
                                        ...
                                        {
                                            if($res->trip_type_id == $trip_type_idd)
                                            {
