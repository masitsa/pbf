    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-4">
                	<input type="text" class="form-control" name="airport_name" placeholder="Airport Name" value="<?php echo set_value('airport_name');?>">
                </div>
            </div>
            <!-- airport Name -->
            <div class="form-group">
                ...
                <div class="col-lg-4">
                	<input type="text" class="form-control" name="location_name" placeholder="Airport Location" value="<?php echo set_value('location_name');?>">
                </div>
            </div>
            <!-- Activate checkbox -->
            <div class="form-group">
