		...
		if ($query->num_rows() > 0)
		{
			...
			foreach ($query->result() as $row)
			{
				...
				if($visitor_status == 0)
				{
					...
					$button = '<a class="btn btn-info" href="'.site_url().'administration/activate-visitor/'.$visitor_id.'" onclick="return confirm(\'Do you want to activate '.$visitor_first_name.' '.$visitor_last_name.'?\');">Activate</a>';
				}
				//create activated status display
				else if($visitor_status == 1)
				{
					$status = '<span class="label label-success">Active</span>';
					$button = '<a class="btn btn-info" href="'.site_url().'administration/deactivate-visitor/'.$visitor_id.'" onclick="return confirm(\'Do you want to deactivate '.$visitor_first_name.' '.$visitor_last_name.'?\');">Deactivate</a>';
				}
				...
				'
					<tr>
						<td>'.$count.'</td>
						<td><img src="'.base_url()."assets/images/visitors/".$thumb.'"></td>
