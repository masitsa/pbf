...
<div class="admin-form">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <!-- Widget starts -->
            <div class="logo"><a href="<?php echo $this->uri->uri_string();?>" class="navbar-brand"><span class="bold">A</span>irline Login</a></div>
            <div class="widget">
              <!-- Widget head -->
              ...
              <div class="widget-content">
                ...
                <div class="widget-foot ">
                 Dont have an account?
                   <a href="<?php echo site_url()."airline/airline_signup1";?>" >Click to sign up</a>
                <br>
